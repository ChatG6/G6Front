...
export const QuillToolbar = () => {
  ...
  useOnClickOutside(ref7, handlecanceleq);
  ...
  return (
    <div id="toolbar" className="mx-auto">
      ...
      <span className="flex flex-row items-center">
        <div className="cont-imp" ref={ref7}>
          <button
            className="ql-getarts "
            onClick={handlegeteq}
            style={{
        ...
        <button className="ql-formula mr-1" onClick={handleq}>
